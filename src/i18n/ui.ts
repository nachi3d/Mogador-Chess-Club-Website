...
const fr = {
  ...
  /* 0017 — the award notice. ⚠️ NO PRONOUN FOR THE READER: a parent reads
     it as often as the student does (Critical Feature 54), so the copy names
     the child and the jetons, never "tes" or "vos". */
  'award.title': 'Jetons reçus',
  'award.new': 'Nouveau',
  'award.for': 'Pour {name}',
  'award.amount': '+{n} jetons',
  'award.amount.one': '+1 jeton',
  'award.reason': '« {reason} »',
  'award.by': 'Donné par {name}',
  'award.by.club': 'Donné par le club',
  'award.read': 'Compris',
  'award.read.aria': 'Compris — marquer les jetons de {name} comme lus',
  'award.saving': 'Un instant…',
  'award.done': 'C’est noté.',
  'award.failed': 'Pas enregistré. Réessayez dans un instant.',
  'award.shop': 'Voir la boutique',
...
const en: Record<keyof typeof fr, string> = {
  ...
  'award.title': 'Tokens received',
  'award.new': 'New',
  'award.for': 'For {name}',
  'award.amount': '+{n} tokens',
  'award.amount.one': '+1 token',
  'award.reason': '“{reason}”',
  'award.by': 'Given by {name}',
  'award.by.club': 'Given by the club',
  'award.read': 'Got it',
  'award.read.aria': 'Got it — mark {name}’s tokens as read',
  'award.saving': 'One moment…',
  'award.done': 'Noted.',
  'award.failed': 'Not saved. Please try again in a moment.',
  'award.shop': 'See the shop',
