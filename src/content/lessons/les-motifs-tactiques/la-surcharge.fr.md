...
boards: [{"kind":"position","fen":"6k1/4qppp/8/6n1/8/8/3B4/4R2K w - - 0 1","caption":"La dame a deux missions. Elle défend le cavalier en g5, et la case e8 qui protège la dernière rangée. Les Blancs prennent le cavalier. Si la dame reprend, elle quitte la colonne e — et la tour arrive en e8 avec mat."},{"kind":"exercise","fen":"6k1/4qppp/8/6n1/8/8/3B4/4R2K w - - 0 1","solution":["d2g5"],"opponentReplies":[],"onlyMove":true,"task":"Gagne le cavalier.","hint":"Prends-le. Si la dame reprend, regarde ce qu'elle abandonne."}]
draft: false
---
