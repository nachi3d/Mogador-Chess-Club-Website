...
## Signing in with a pseudo — migration 0015 (v0.18.0)
...
## The pseudo path — the rules as CLAUDE.md carried them (moved, v0.30.0)

**Read when** touching `/connexion/`, `/inscription/`, `/mot-de-passe/` or the
reset control. CLAUDE.md keeps the four rules a session could break without
going looking; this is the full list it carried before the size guard warned.
