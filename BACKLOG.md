...
| **M3 — density pass on the inner pages** | `next` | Cours, exercices, pièges still use the desktop card treatment on mobile. M1/M2 changed the shell and the home page only. |
